...
global.ig = 'darksword54' // ubah aja
global.email = 'guidigloonias15@gmail.com' //serah
global.region = 'nigeria' // serah
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'ꪶ༺֎ᚏ༈࿉Raizen⧉ᚙ֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
global.owner = ['22871255034'] // ubah aja pake nomor lu
//==========================zetsuboclient=======================//
global.botname = '⫹⸙⧉Darki-𝐁𝐔𝐆-𝐁𝐎𝐓⧉⸙⫺' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.packname = '⫹⸙⧉Darki-𝐁𝐔𝐆-𝐁𝐎𝐓⧉⸙⫺' // ubah aja ini nama sticker
